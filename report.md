...
* [ZFS](#zfs)
    ...
    * [to delete](#to-delete)
      * [Как получить dnode?](#Как-получить-dnode)
...
![Диаграмма исходного кода ZFS (1)](./img/zfs-src.png "Диаграмма исходного кода ZFS (1)")
...
![Структура метки ZFS (2)](./img/zfs-label.png "Структура метки ZFS (2)")
...
!["Соседние" виртуальные устройства (3)](./img/zfs-label-neighbors-vdev.png "\"Соседние\" виртуальные устройства (3)")
...
![Структура blkptr_t (4)](./img/zfs-blkptr-struct.png "Структура blkptr_t (4)")
